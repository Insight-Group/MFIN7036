# -*- coding: utf-8 -*-
"""
Created on Sun Feb 28 17:35:13 2021
...
class VaderConstants:
    ...
    # for valence initial setting in 'def _never_check'
    N_SCALAR = -0.74   
...
class SentiText:
    ...
    def _words_plus_punc(self):
        ...
        """
        # x.sub("",'I love you. Do you love me?')
    ...
    def _words_and_emoticons(self):
        ...
        """
        # 'you and me!'.split() ==> ['you', 'and', 'me!']
        wes = self.text.split()
        words_punc_dict = self._words_plus_punc()
        wes = [we for we in wes if len(we) > 1]
        # list(enumerate(['you', 'and', 'me!']))
        # ==> [(0, 'you'), (1, 'and'), (2, 'me!')]
...
class SentimentIntensityAnalyzer:
    ...
    def make_lex_dict(self):
        ...
        # {..., 'beautician': 1.2, 'beauticians': 0.4, ...}
        return lex_dict

    def polarity_scores(self, text, tfidf_dict):
        """
        ...
        for item in words_and_emoticons:
            ...
            sentiments = self.sentiment_valence(valence, sentitext, item, i, sentiments, tfidf_dict)
    ...
    def sentiment_valence(self, valence, sentitext, item, i, sentiments, tfidf_dict):
        ...
        if item_lowercase in self.lexicon:
            ...
            for start_i in range(0, 3):
                if (
                    i > start_i
                    # 减弱本词前三个词如果不在lexicon里的影响，往前数，依次衰减至1,0.95,0.9
                    ...
                    # 往前数第2个词，并且该词不在BOOSTER_DICT中
                    if start_i == 1 and s != 0:
                        s = s * 0.95
                    # 往前数第3个词，并且该词不在BOOSTER_DICT中
        ...
        if tfidf_dict.get(item_lowercase) is not None:
            valence = valence * tfidf_dict.get(item_lowercase)
    ...
    def _but_check(self, words_and_emoticons, sentiments):
        ...
        if but:
            ...
            for sidx, sentiment in enumerate(sentiments):
                # but对前面词汇的情绪影响调整为原来的0.5
                if sidx < bi:
                    sentiments[sidx] = sentiment * 0.5
                # but对后面词汇的情绪影响调整为原来的1.5
                elif sidx > bi:
